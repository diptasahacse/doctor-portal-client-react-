    ...
    return (
        <div className='py-12' style={{ backgroundImage: `url(${appointment})` }}>
            ...
            <div className='flex justify-center'>
                <form>
                    <input className=' m-2 p-3 w-full rounded-lg' type="email" name="" placeholder='Email Address' />
                    <br />
                    <input className=' m-2 p-3 w-full rounded-lg' type="text" name="" placeholder='Subject' />
                    <br />
                    <textarea className=' m-2 p-3 w-full rounded-lg' name="" cols="30" rows="5" placeholder='Your message'></textarea>
                    <br />
